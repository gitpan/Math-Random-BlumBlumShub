...
$Math::Random::BlumBlumShub::VERSION = '0.01';

DynaLoader::bootstrap Math::Random::BlumBlumShub $Math::Random::BlumBlumShub::VERSION;

@Math::Random::BlumBlumShub::EXPORT_OK = qw(bbs bbs_seedgen monobit longrun runs poker);
%Math::Random::BlumBlumShub::EXPORT_TAGS =(all => [qw(bbs bbs_seedgen monobit longrun runs poker)]);
